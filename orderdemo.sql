...
--
-- Host: localhost
-- Generation Time: Jun 24, 2013 at 10:31 PM
...
CREATE TABLE IF NOT EXISTS `order_items` (
  ...
  `ex_vat` decimal(10,2) NOT NULL,
  `incl_vat` decimal(10,2) NOT NULL,
  `created` datetime NOT NULL,
  `modified` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=3 ;
...
INSERT INTO `order_items` (`id`, `quote_id`, `product_id`, `price`, `qty`, `ex_vat`, `incl_vat`, `created`, `modified`) VALUES
(1, 1, 2, 50.00, 1, 50.00, 57.00, '2013-06-24 00:00:00', '2013-06-24 00:00:00'),
(2, 1, 15, 100.00, 1, 100.00, 114.00, '2013-06-24 00:00:00', '2013-06-24 00:00:00');
